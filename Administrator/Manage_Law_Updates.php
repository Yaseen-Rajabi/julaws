...
JU                        </div>
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>القوانين والتعليمات والأنظمة | <a href="Add_New_Law_Update.php?L_ID=<?php echo $L_ID; ?>" class="btn btn-primary">اضافة تحديث جديد للمادة</a></h2>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>عرض معلومات قائمة التحديثات على القانون</h5>
                    ...
                    <tr class="grade">
                          ...
                          <td><?php echo $Update_Date_Time; ?></td>
                          
                         
                     
 <td><center>
 
 <a href="JavaScript:if(confirm('هل انت متأكد من تحديث المادة؟')==true)
{location.replace('Delete_Law_Update.php?L_ID=<?php echo $L_ID; ?>&LU_ID=<?php echo $LU_ID; ?>')}" class="btn btn-primary btn-sm" role="button">حذف</a>
