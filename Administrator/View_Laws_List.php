...
JU                        </div>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>عرض معلومات قائمة القوانين والتعليمات والأنظمة</h5>
 ...
 <a href="Edit_Law.php?L_ID=<?php echo $L_ID; ?>" style="width:52px" class="btn btn-primary btn-sm" role="button">تعديل</a>
 <br>
 <a href="JavaScript:if(confirm('هل انت متأكد من حذف المادة؟')==true)
{location.replace('Delete_Law.php?L_ID=<?php echo $L_ID; ?>')}" class="btn btn-primary btn-sm" role="button">حذف</a>
