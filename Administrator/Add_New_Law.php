...
?>  				
                                ...
                                <div class="hr-line-dashed"></div>
								 ...
								 <div class="form-group"><label class="col-sm-2 control-label">السنة الأكاديمية *</label>
                                    ...
                                    <div class="col-sm-10"><input value=""  type="text" name="Academic_Year" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
 ...
 <div class="form-group"><label class="col-sm-2 control-label">التصنيف الاول </label>
                                    ...
                                    <div class="col-sm-10"><input value=""  type="text" name="Sub_Category_1" class="form-control" ></div>
                                </div>
                                <div class="hr-line-dashed"></div>
 ...
 <div class="form-group"><label class="col-sm-2 control-label">التصنيف الثاني </label>
                                    ...
                                    <div class="col-sm-10"><input value=""  type="text" name="Sub_Category_2" class="form-control" ></div>
                                </div>
                                <div class="hr-line-dashed"></div>
 ...
 <div class="form-group"><label class="col-sm-2 control-label">التصنيف الثالث </label>
                                    ...
                                    <div class="col-sm-10"><input value=""  type="text" name="Sub_Category_3" class="form-control" ></div>
                                </div>
                                <div class="hr-line-dashed"></div>
 ...
 <div class="form-group"><label class="col-sm-2 control-label">نص المادة *</label>
                                    ...
                                    <div class="col-sm-10"><textarea   name="Details" class="form-control" rows="10" required></textarea></div>
                                </div>
                                <div class="hr-line-dashed"></div>
