...
if (isset($_POST['Submit'])) {
    ...
    echo "<script language='JavaScript'>
			  alert ('تم اضافة تصنيف جديد بنجاح !');
      </script>";
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                ...
                                <form method="post" action="Add_New_Category.php" class="form-horizontal"
                                    enctype="multipart/form-data">
                                    <!-- enctype: it allows entire files to be included in the data. -->



                                    <div class="form-group"><label class="col-sm-2 control-label">الاسم *</label>

                                        <div class="col-sm-10"><input value="" type="text" name="Category_Name"
